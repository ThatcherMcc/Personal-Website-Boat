...
export default function UndeadSettlementPage() {
  return (
    <>
      <AllowScroll />
      <div
      ...
      >
        ...
        <div className="relative z-10 p-8 flex flex-col items-center justify-center min-h-screen text-white">
          ...
          <section className="max-w-8/10 flex flex-row gap-8 text-center bg-stone-900 bg-opacity-70 p-8 rounded-lg shadow-2xl backdrop-filter backdrop-blur-sm mb-10">
            <Image
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <p className="text-lg text-left font-serif leading-relaxed">
                  Hi, I'm <strong className="text-green-600">Thatcher</strong>,
                  a creator at heart who finds his fulfillment and escape from
                  overconsumption in the act of building for myself and others.
                  I think creation has many forms, whether it's a solution to a
